function [t_roll,Pss,bank_angle_till_steady] = aileron_setting(CL_alpha_wing,C_aileron,C_wing,inner_edge_ail_perc,outer_edge_ail_perc,S_wing,b_wing,d_aileron,q_flight,rho_flight,S_horiontal,S_vertical,Ixx,dersired_roll_angle)
    ...
    Y_0 = inner_edge_ail_perc*(b_wing/2);
    Y_1 = outer_edge_ail_perc*(b_wing/2);
    ...
    if dersired_roll_angle < bank_angle_till_steady,
        t_roll = (2*dersired_roll_angle/P_dot)^0.5;
    else
        t_roll = (2*bank_angle_till_steady/P_dot)^0.5 +(dersired_roll_angle-bank_angle_till_steady)/Pss;
    end
